...
export default memo(() => {
  ...
  useEffect(() => {
    ...
    // Read the data
    d3.csv(musicFile).then((data_) => {
      const data = (
        data_ as any as { Time: number; Amplitude: number }[]
      ).slice(500, 1500); 
      // console.log(data);
      ...
      const currentAmplitudeText = svg
        .append("text")
        .attr("x", width - 100)
        .attr("y", y(0) - 10)
        .attr("fill", "red")
      ...
      const slider = d3
        ...
        .on(
          ...
          /*throttle(500, () =>*/ {
            ...
            currentAmplitudeText
              .text(`Amplitude: ${data[timeIndex].Amplitude.toFixed(2)}`)
